...
class CBNTGA : public IOptimizer
{
public:

	CBNTGA(const SOptimizerParams& optParams, const IProblem* optProblem);
	~CBNTGA();
...
private:
	...
	struct SBNTGAParams : SOptimizerParams
	{
		SBNTGAParams(const SOptimizerParams& optParams, const IProblem* optProblem);
		~SBNTGAParams();
